...
[![](https://godoc.org/github.com/nooko/go-rabbitmq?status.svg)](https://godoc.org/github.com/nooko/go-rabbitmq)![Deploy](https://github.com/nooko/go-rabbitmq/workflows/Tests/badge.svg)
...
```bash
go get github.com/nooko/go-rabbitmq
```
